...
function Footer() {
  return (
    <div className="p-4 rounded-lg shadow md:flex md:items-center md:justify-between md:p-6 fixed bottom-0 w-full">
      <ul className="flex flex-wrap items-center mt-3 text-sm text-white-500 dark:text-indigo-700 sm:mt-0 text-lg">
        ...
        <li className="ml-5">
          ...
          >
            <svg
             className="w-9 h-9 content-center"
             fill="currentColor"
             viewBox="0 0 50 50"
             aria-hidden="true"
            >
        ...
        <li className="ml-5">
          <a
            href="https://github.com/hollygparker"
            className="text-gray-400 hover:text-grey-900 dark:hover:text-blue"
          >
            <svg
             className="w-9 h-9 content-center"
        ...
        {/* RESUME */}
        <li>
          <a href="#" className="mr-4 hover:underline md:mr-6 ml-5">
